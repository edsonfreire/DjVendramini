...
<html>
    <head>
        ...
        <title>DJ Ricardo Vendramini</title>
    ...
    <body>
        ...
        <div id="ac_content" class="ac_content">
            <h1><a href="http://www.ricardovendramini.com.br"><span>DJ Ricardo</span>Vendramini</a></h1>
            <div class="ac_menu">
                <ul>
                    <li><!--historia-->
        ...
        <!-- The JavaScript -->
        <script type="text/javascript" src="addIn/jquery.min.js"></script>
        <script type="text/javascript" src="addIn/jquery.easing.1.3.js"></script>
